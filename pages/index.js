        ...
        <body class="bg-white dark:bg-gray-900">
            ...
            <div class="container px-6 py-10 mx-auto text-center">
                <div class="mx-auto">
                    ...
                    <p class="mt-6 text-gray-500 text-xl dark:text-gray-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Libero similique obcaecati illum mollitia.</p>
                    <div class="space-x-4">
